...
- **일반** — 테마, Dock 아이콘, 로그인 시 자동 실행, 앱 종료 시 데몬 종료, 첫터치 프리필, 벤치마크 기록 보관, 권한, 언어, 업데이트 확인 주기
...
앱 업데이트는 **앱 메뉴 > 업데이트 확인**에서 확인할 수 있습니다. 새 버전이 있으면 릴리스 노트와 함께
DMG 다운로드 안내가 표시되고, 설정 > 일반에서 확인 주기(실행 시/매일/매주/안 함)를 바꿀 수 있습니다.
